#ifndef TIASCRIPT_INC
#define TIASCRIPT_INC
...
#define PY_ARRAY_UNIQUE_SYMBOL  _tiascript_numpy_API
#define NPY_NO_DEPRECATED_API   NPY_1_7_API_VERSION

#include <Python.h>

// Use this statement to use the type library from your own stdscript.dll
#import "ESVision.tlb" named_guids raw_interfaces_only raw_method_prefix("raw_")
...
extern PyObject* tiascriptModule;
...
bool      setVectorFromSequence(ESVision::IVector* vec, PyObject* seq);
