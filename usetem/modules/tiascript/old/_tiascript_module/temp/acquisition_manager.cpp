...
static PyObject* AcquisitionManager_get_Cameras(AcquisitionManager *self, void *)
{
    ESVision::CCDCameras* collection;
...
{
    ESVision::STEMDetectors* collection;
    ...
    ESVision::STEMAcqParams* params_iface;
    ...
    PyObject* tuple = PyList_New(count);
    for (long n = 0; n < count; n++) {
        ESVision::STEMDetector* detector;
...
IMPLEMENT_WRAPPER(Acquisition, ESVision::Acquisition, Acquisition_getset, Acquisition_methods)
