...
class Microscope(object):
    ...
    def get_ColValOpen(self):
        return self._tem_vacuum.ColumnValvesOpen

    def set_ColValOpen(self, state):
    ...
    def set_diffraction_shift(self, pos):
        self._tem_projection.DiffractionShift = pos
        #new module added
    def get_defocus(self):
        return self._tem_projection.Defocus

    def set_defocus(self, defo):
        self._tem_projection.Defocus = defo
    ...
    def set_condenser_stig(self, pos):
        self._tem_illumination.CondenserStigmator = pos

    def set_stem_rotation(self, pos):
        self._tem_illumination.StemRotation = pos

    def set_beam_blanked(self, pos):
        self._tem_illumination.BeamBlanked = pos
